...
public class MoesifGovernanceConnectorConfig implements IdentityConnectorConfig {
    ...
    public Map<String, String> getPropertyNameMapping() {
        ...
        nameMapping.put(MoesifConfigurationConstants.MOESIF_LOGIN_PUBLISHER_ENABLED_PROPERTY,
    ...
    public Map<String, String> getPropertyDescriptionMapping() {
        ...
        descriptionMapping.put(MoesifConfigurationConstants.MOESIF_LOGIN_PUBLISHER_ENABLED_PROPERTY,
    ...
    public String[] getPropertyNames() {
        ...
        return new String[]{
                ...
                MoesifConfigurationConstants.MOESIF_LOGIN_PUBLISHER_ENABLED_PROPERTY,
    ...
    public Properties getDefaultPropertyValues(String tenantDomain) throws IdentityGovernanceException {
        ...
        defaultValues.put(MoesifConfigurationConstants.MOESIF_LOGIN_PUBLISHER_ENABLED_PROPERTY,
